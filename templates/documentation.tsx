...
export const Documentation: FC = () => {
    return (
        <a href="https://htmx.org/reference/#attributes" class="flex items-center mt-5 hover:underline hover:underline-offset-4 hover:text-blue-600 text-lg font-medium" target='_blank'>
            HTMX Reference | Core Attributes
